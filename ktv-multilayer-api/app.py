...
app = FastAPI(
    title="Forest Deforestation Analysis API",
    version="1.0.0",
    description="""
...
async def root():
    ...
    """
    return {
        "name": "Forest Deforestation Analysis API",
        "version": "1.0.0",
        "description": "Professional satellite-based forest monitoring API",
        "endpoints": {
            "forest_analysis": "/api/v1/forest-analysis",
            "geojson_processing": "/api/v1/process-geojson",
            "health_check": "/health"
        },
        "documentation": "/docs",
        "contact": "support@forestapi.com"
    }
...
async def forest_analysis(request: ForestAnalysisRequest):
    """
    **Multi-Satellite Forest Analysis**
